...
public class SkeletonRobotCameraScript : MonoBehaviour
{
    public GameObject target;
    public float turnSpeed = .2f;
    public GameObject skeletonRobotCamera;
    ...
    void Update()
    {
        ...
        skeletonRobotCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
